=== passagemingresso-pagseguro ===

Contributors: Andre Webmaster, SITEFLASH.S.A
Donate link: http://andrewebmaster.com.br/doacoes/
Tags: passagemingresso, pagseguro
...
Adds PagSeguro gateway to the PassagemIngresso plugin

== Description ==

### Add PagSeguro gateway to PassagemIngresso ###

Please notice that PassagemIngresso must be installed and active.

= Contribute =

You can contribute to the source code in our [GitHub](https://github.com/siteflash/passagemingresso-pagseguro.git) page.

### Descrição em Português: ###

Adicione o PagSeguro como método de pagamento em seu [PassagemIngresso](wordpress.org/extend/plugins/passagemingresso/).
...
* Criando um tópico no repositório do plugin no [GitHub](https://github.com/siteflash/passagemingresso-pagseguro.git).
* Criando um tópico no [fórum de ajuda do WordPress](http://wordpress.org/support/plugin/camptix-pagseguro) (apenas em inglês).

= Coloborar =

Você pode contribuir com código-fonte em nossa página no [GitHub](https://github.com/siteflash/passagemingresso-pagseguro.git).
...
* [PassagemIngresso](wordpress.org/extend/plugins/passagemingresso/) installed and active;
...
Entre em contato [clicando aqui](http://andrewebmaster.com.br/contatos).
...
* Removed get_query_var() for ingresso_action in favor to $_GET (Issue [#4](https://github.com/siteflash/passagemingresso-pagseguro.git/issues/4)).
